...
/**
 * Account control for the header: a round avatar (the email initial) with a
 * chevron that opens a dropdown — All projects, Settings, Sign out. Closes on
 * outside click or Escape.
 */
export default function AccountMenu({ userEmail, userName = '' }: { userEmail: string; userName?: string }) {
  const [open, setOpen] = useState(false);
  const ref = useRef<HTMLDivElement>(null);
  // One letter, favouring the display name, falling back to the email.
      ...
      {open && (
        <div className="acct-menu" role="menu">
          ...
          <form action="/auth/signout" method="post">
            <button className="acct-item danger" role="menuitem" type="submit">
